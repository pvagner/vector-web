            ...
            <div className="mx_MessageComposer">
                <div className="mx_MessageComposer_wrapper">
                    <div className="mx_MessageComposer_row">
                        ...
                        <div className="mx_MessageComposer_voicecall" button="button" tabIndex="0" onClick={this.onVoiceCallClick} onKeyUp={this.onButtonsKeyup}>
                            <img src="img/voice.png" alt="Voice call" title="Voice call" width="16" height="26"/>
                        </div>
                        <div className="mx_MessageComposer_videocall" role="button" tabIndex="0" onClick={this.onCallClick} onKeyUp={this.onButtonsKeyup}>
