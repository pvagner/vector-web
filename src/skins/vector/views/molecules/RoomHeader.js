...
/*                
                if (activeCall && activeCall.type === "video") {
                    muteVideoButton = (
                        <div className="mx_RoomHeader_textButton mx_RoomHeader_voipButton" role="button" tabIndex="0"
                                onClick={this.onMuteVideoClick} onKeyDown={this.props.onButtonsKeydown}>
                            {
                        ...
                        {muteVideoButton}
                        <div className="mx_RoomHeader_textButton mx_RoomHeader_voipButton" role="button" tabIndex="0"
                                onClick={this.onMuteAudioClick} onKeyDown={this.props.onButtonsKeydown}>
                            {
...
*/                
                ...
                call_buttons = (
                    <div className="mx_RoomHeader_textButton" role="button" tabIndex="0"
                            onClick={this.onHangupClick} onKeyDown={this.props.onButtonsKeydown}>
                        End call
                    </div>
                );
            }
