    ...
    render: function() {
        return (
            <div className="mx_GuestWarningBar">
                ...
                <div>
                    You are Rioting as a guest. <a tabIndex="0" onClick={this.onRegisterClicked}>Register</a> or <a tabIndex="0" onClick={this.onLoginClicked}>sign in</a> to access more rooms and features.
                </div>
            </div>
        );
    }
